...
import com.dean.googleplay.utils.AnimationUtil;

/**
 * 淡入淡出布局，向下滑动从远拉到近，向上滑动从近拉到远
 * <pre>
 * StellarMap stellarMap = new StellarMap(x.app());
 * // 设置四周的距离
 * stellarMap.setInnerPadding(DensityUtil.dip2px(13),
 *                              DensityUtil.dip2px(13),
*                               DensityUtil.dip2px(13),
 *                              DensityUtil.dip2px(13));
 ...
 * //设置几行几列
 * stellarMap.setRegularity(6, 9);</pre>
 */
